...
|---|---|---|
| `mark-light.svg` / `mark-dark.svg` | Two Pins | The primary mark: app header and README |
| `icon-light.svg` / `icon-dark.svg` | Viewport | App icon; `../favicon.svg` is the same mark with the theme switch built in |
| `state-map-light.svg` / `-dark.svg` | Dropped Pin | Empty state on the map, before any room exists |
